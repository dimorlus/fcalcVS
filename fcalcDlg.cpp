...
void CfcalcDlg::UpdateResult()
{
    ...
    sprintf_s(strings[n++], 80, "lineHeight % d", lineHeight);
    ...
    // Фиксированная высота с корректировкой (на основе ваших правок)
    lineHeight = 20; // Фиксированное значение, протестировано на 1920x1080
    int margin = 0; // Убираем лишний запас
    ...
    int newHeight = totalExtraHeight + 30 + (lineHeight * (lineCount ? lineCount : 1)); // +30 по вашим правкам
